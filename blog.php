...
$pw=!empty($_POST['pw'])?htmlspecialchars(trim($_POST['pw'])):'';
...
if (!$smarty->isCached('blog.html', $cache_id))
{
	if ($keywords)
	{
...
/* 更新点击次数 */
$sql='UPDATE ' . table('blog') . " SET views = views + 1 WHERE blog_id = '$id'";
